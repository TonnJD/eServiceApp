...
var DetaillistpmPage = /** @class */ (function () {
    ...
    DetaillistpmPage.prototype.checkCurrentWork = function (data) {
        var cusName = this.items.item.Customer;
        // console.log('cusName', cusName);
        // console.log('includes', cusName.includes('อินาบะ'));
        var selectData = this.data[0].productInstall.find(function (x) { return x.tranID != null && x.summitDate == "False"; });

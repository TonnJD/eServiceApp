...
var DetailofdetaillistpmPage = /** @class */ (function () {
    ...
    function DetailofdetaillistpmPage(camera, modalController, route, navCtrl, sanitizer, storageService, alertController, auth, postDataService, toastCtrl) {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            console.log('this.install', _this.install);
            if (_this.type == 'CM') {
                ...
                if (_this.jobtype == 'PM') {
                    ...
                    if (_this.jobtype == 'CM') {
                        ...
                        if (_this.spareList.length > 0) {
                            ...
                            _this.postDataService.RequestSparepart(params_3);
                        }
                        var params_4 = {
                            item: _this.item,
                            type: "getCM",
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (this.install.RoundFilter != null) {
                    this.postDataService.CheckRoundFilter(this.install.tranID).then(function (res) {
                        var tranData = res;

...
var PostDataService = /** @class */ (function () {
    ...
    PostDataService.prototype.RecheckInstallPlan = function (insID, insName) {
        var _this = this;
        return new Promise(function (resovle, reject) {
            var option = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
            _this.http.get(_this.apiServer_url + '/API/WebService.asmx/RecheckInstallPlan?insID=' + insID + '&installName=' + insName, option).subscribe(function (data) {
                resovle(data);
            }, function (error) {
                reject(error);
            });

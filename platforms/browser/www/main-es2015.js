...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, http, authenticationService, router) {
...
/* harmony import */ var _fullcalendar_angular__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @fullcalendar/angular */ "./node_modules/@fullcalendar/angular/fesm2015/fullcalendar-angular.js");
...
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
...
let AuthServiceService = class AuthServiceService {
    constructor(http, postDataService) {
        this.http = http;
...
let AuthenticationService = class AuthenticationService {
    constructor(storage, plt, storageService) {
...
let LogPageModule = class LogPageModule {
};
...
let LogPage = class LogPage {
    constructor(modalController, navParams, navCtrl, postDataService, sanitizer, alertController) {
...
let ShowimginstallPageModule = class ShowimginstallPageModule {
};
...
let ShowimginstallPage = class ShowimginstallPage {
    constructor(modalController, navParams, postDataService) {
        this.modalController = modalController;
        this.navParams = navParams;
        this.postDataService = postDataService;
        this.booimg1 = false;
...
ShowimginstallPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"] },
...
let UpdateProductPage = class UpdateProductPage {
    constructor(route, navParams, modalCtrl, postDataService, alertCtrl, navCtrl, toastCtrl) {
        this.route = route;
        this.navParams = navParams;
        this.modalCtrl = modalCtrl;
        this.postDataService = postDataService;
...
let ChangsparepartPageModule = class ChangsparepartPageModule {
};
...
let ChangsparepartPage = class ChangsparepartPage {
    constructor(modalController, postDataService, barcodeScanner, alertController, navParams, http, toastCtrl) {
        this.modalController = modalController;
        this.postDataService = postDataService;
    ...
    closeModal(i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.modalController.dismiss(i);
        });
    }
    checkin() {
...
ChangsparepartPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _post_data_service__WEBPACK_IMPORTED_MODULE_3__["PostDataService"] },
...
let CheckevaluationPageModule = class CheckevaluationPageModule {
};
...
let CheckevaluationPage = class CheckevaluationPage {
    //#endregion
    //#region constructor
    constructor(modalController, postDataService, navParams, alertController, sanitizer) {
        this.modalController = modalController;
        this.postDataService = postDataService;
        this.navParams = navParams;
        this.alertController = alertController;
...
CheckevaluationPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _post_data_service__WEBPACK_IMPORTED_MODULE_4__["PostDataService"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"] },
...
let ChecklistcmPageModule = class ChecklistcmPageModule {
};
...
ChecklistcmPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _ionic_native_barcode_scanner_ngx__WEBPACK_IMPORTED_MODULE_4__["BarcodeScanner"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"] },
...
let CustomerevaluationPageModule = class CustomerevaluationPageModule {
};
...
let CustomerevaluationPage = class CustomerevaluationPage {
    constructor(postDataService, modalController, alertCtrl, navCtrl, navParams, route) {
        this.postDataService = postDataService;
        this.modalController = modalController;
        this.alertCtrl = alertCtrl;
        this.navCtrl = navCtrl;
...
CustomerevaluationPage.ctorParameters = () => [
    { type: _post_data_service__WEBPACK_IMPORTED_MODULE_3__["PostDataService"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"] },
...
let CustomerpasswordPageModule = class CustomerpasswordPageModule {
};
...
let CustomerpasswordPage = class CustomerpasswordPage {
    constructor(modalController, alertController, postDataService, navParams) {
        this.modalController = modalController;
        this.alertController = alertController;
        this.postDataService = postDataService;
        this.navParams = navParams;
    ...
    closeModal() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.modalController.dismiss(0);
        });
    }
    confirmSubmit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.type == 'PM') {
                ...
                if (this.code == this.getpassword && this.Cuscomment != "" && this.Cuscomment != null) {
                    ...
                    yield this.modalController.dismiss(params);
                }
            }
...
CustomerpasswordPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"] },
    { type: _post_data_service__WEBPACK_IMPORTED_MODULE_3__["PostDataService"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"] }
...
let RequestsparepartPage = class RequestsparepartPage {
    constructor(postDataService, navParams, modalCtrl, alertCtrl, navCtrl, toastCtrl) {
        this.postDataService = postDataService;
        this.navParams = navParams;
        this.modalCtrl = modalCtrl;
        this.alertCtrl = alertCtrl;
...
let SignaturePage = class SignaturePage {
    constructor(nav, modalCtrl, navParams, storage, navCtrl, postDataService, storageService, modalController, alertCtrl) {
        this.nav = nav;
        this.modalCtrl = modalCtrl;
        this.storage = storage;
        this.navCtrl = navCtrl;
...
let NotCheckedPageModule = class NotCheckedPageModule {
};
...
let NotCheckedPage = class NotCheckedPage {
    constructor(postDataService, navParams, modalCtrl, cam) {
        this.postDataService = postDataService;
        this.navParams = navParams;
        this.modalCtrl = modalCtrl;
        this.cam = cam;
    ...
    Take(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (id == 1) {
                this.cam.getPicture(this.camOptions).then((image) => {
                    ...
                    let params = {};
                    console.log('error photo1', this.photo1);
                    // this.postDataService.SaveCaseAll(params).then(photoID => {
                    // });
                });
            }
            if (id == 2) {
                this.cam.getPicture(this.camOptions).then((image) => {
                    ...
                    let params = {};
                    console.log('error photo2', this.photo2);
                    // this.postDataService.SaveCaseAll(params).then(photoID => {
                    // });
                });
            }
...
let ModalpopPageModule = class ModalpopPageModule {
};
...
let ModalpopPage = class ModalpopPage {
    //#endregion
    //#region constructor
    constructor(router, popoverController, navParams, navCtrl) {
        this.router = router;
...
let ChangpasswordPageModule = class ChangpasswordPageModule {
};
...
let ChangpasswordPage = class ChangpasswordPage {
    constructor(modalController, alertController, postDataService, storageService) {
        this.modalController = modalController;
        this.alertController = alertController;
        this.postDataService = postDataService;
        this.storageService = storageService;
...
ChangpasswordPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"] },
    { type: _post_data_service__WEBPACK_IMPORTED_MODULE_3__["PostDataService"] },
...
let AddSparepartPageModule = class AddSparepartPageModule {
};
...
let AddSparepartPage = class AddSparepartPage {
...
AddSparepartPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"] }
];
...
let PartsWaitingListPageModule = class PartsWaitingListPageModule {
};
...
let PartsWaitingListPage = class PartsWaitingListPage {
    constructor(modalController, navParams, navCtrl, postDataService, sanitizer, alertController) {
        this.modalController = modalController;
        this.navParams = navParams;
        this.navCtrl = navCtrl;
...
PartsWaitingListPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"] },
    { type: _post_data_service__WEBPACK_IMPORTED_MODULE_4__["PostDataService"] },
...
let ReqDetailPageModule = class ReqDetailPageModule {
};
...
let SparepartPage = class SparepartPage {
    constructor(modalController, postDataService, route, navCtrl, alertCtrl, modalCtrl, navParams) {
        // this.route.queryParams.subscribe(params => {
        //   console.log('params', params);
...
let TakeNewPageModule = class TakeNewPageModule {
};
...
let TakeNewPage = class TakeNewPage {
    constructor(navParams, modalController, alertController, navCtrl, postDataService) {
        this.navParams = navParams;
        this.modalController = modalController;
        this.alertController = alertController;
        this.navCtrl = navCtrl;
...
let TakePageModule = class TakePageModule {
};
...
let TakePage = class TakePage {
    constructor(modalController, navParams, postDataService, storageService) {
        this.modalController = modalController;
        this.navParams = navParams;
        this.postDataService = postDataService;
        this.storageService = storageService;
...
let PostDataService = class PostDataService {
    ...
    changpassword(pass) {
        ...
        return new Promise((resovle, reject) => {
            ...
            this.http.post(this.apiServer_url + '/API/Login.ashx' + '?empID=' + pass.empID + '&type=' + pass.type + '&passold=' + pass.old + '&passnew=' + pass.new, JSON.stringify(pass), option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
    ...
    postjobOverview(user) {
        return new Promise((resovle, reject) => {
            let option = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
            this.http.post(this.apiServer_url + '/API/JobOverview.ashx' + '?empID=' + user.empID + '&month=' + user.month + '&year=' + user.year, JSON.stringify(user), option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
    ...
    postjobDetail(jobdetail) {
        return new Promise((resovle, reject) => {
            ...
            this.http.post(this.apiServer_url + '/API/DetailJob.ashx' + '?planID=' + jobdetail.planID + '&tranID=' + jobdetail.tranID + '&type=' + jobdetail.type
                + '&insID=' + jobdetail.insID, JSON.stringify(jobdetail), option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
    ...
    postJobList(job) {
        return new Promise((resovle, reject) => {
            ...
            this.http.post(this.apiServer_url + '/API/JobList.ashx' + '?empID=' + job.empID + '&month=' + job.month + '&year=' + job.year
                + '&jobtype=' + job.jobtype, JSON.stringify(job), option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
    ...
    postGetList(job) {
        return new Promise((resovle, reject) => {
            let option = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
            this.http.post(this.apiServer_url + '/API/JobList.ashx' + '?PlanID=' + job.PlanID + '&jobtype=' + job.jobtype, JSON.stringify(job), option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
    ...
    postListpm(job) {
        return new Promise((resovle, reject) => {
            let option = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
            this.http.post(this.apiServer_url + '/API/Listpm.ashx' + '?empID=' + job.empID + '&month=' + job.month + '&year=' + job.year, JSON.stringify(job), option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
    ...
    postDetailListpm(detaillistpm) {
        return new Promise((resovle, reject) => {
            ...
            this.http.post(this.apiServer_url + '/API/DetailListpm.ashx' + '?cusID=' + detaillistpm.cusID + '&planID=' + detaillistpm.planID + '&month=' + detaillistpm.month
                + '&year=' + detaillistpm.year + '&jobtype=' + detaillistpm.type + '&date=' + detaillistpm.date + '&empid=' + detaillistpm.empid, JSON.stringify(detaillistpm), option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
    ...
    postEmployee(emp) {
        return new Promise((resovle, reject) => {
            let option = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
            this.http.post(this.apiServer_url + '/API/Employee.ashx' + '?empID=' + emp.empid, JSON.stringify(emp), option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
    ...
    postServicaPlan(serviceplan) {
        return new Promise((resovle, reject) => {
            let option = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
            this.http.post(this.apiServer_url + '/API/DetailListpm.ashx' + '?empID=' + serviceplan.empID + '&month=' + serviceplan.month + '&year=' + serviceplan.year, JSON.stringify(serviceplan), option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
    ...
    postTran(tran) {
        return new Promise((resovle, reject) => {
            let option = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
            this.http.post(this.apiServer_url + '/Web/CK_Check.aspx' + '?empID=' + tran.empID + '&serviceplanid=' + tran.serviceplanid + '&installplanid=' + tran.installplanid, JSON.stringify(tran), option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
    ...
    GenReport(tran) {
        return new Promise((resovle, reject) => {
            let option = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
            this.http.post(this.apiServer_url + '/Web/GenerateReport.aspx' + '?tranid=' + tran.tranid, JSON.stringify(tran), option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
    ...
    RecheckInstallPlan(insID, insName, assetno) {
        return new Promise((resovle, reject) => {
            let option = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
            this.http.get(this.apiServer_url + '/API/WebService.asmx/RecheckInstallPlan?insID=' + insID + '&installName=' + insName + '&assetNo=' + assetno, option).subscribe(data => {
                resovle(data);
            }, error => {
                reject(error);
            });
...
PostDataService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let StorageService = class StorageService {
    ...
    addSig(sig) {
        return this.storage.get(sig_KEY).then((sigs) => {
            alert(1);
            if (sigs) {
                sigs.push(sig);
    ...
    addUser(user) {
        return this.storage.get(user_KEY).then((users) => {
            if (users) {
                users.push(user);

...
var PicserialPageModule = /** @class */ (function () {
    function PicserialPageModule() {
    }
...
var PicserialPage = /** @class */ (function () {
    function PicserialPage(route, camera, navCtrl, storageService, postDataService) {
        var _this = this;
        this.route = route;
        this.camera = camera;
    ...
    PicserialPage.prototype.ngOnInit = function () {
    };
    PicserialPage.prototype.GetSerial = function () {
        var _this = this;
        var params = {
        ...
        console.log(params);
        this.postDataService.postdevice(params).then(function (picserial) {
            if (picserial == false) {
                picserial = null;
            }
            else {
                _this.picserial = _this.apiServer_url + picserial;
            }
            console.log(_this.picserial);
        });
    };
    PicserialPage.prototype.TakeSerial = function () {
        var _this = this;
        this.camera.getPicture(this.cameraOptions).then(function (imageData) {
            ...
            if (_this.photo1 == null || "") {
                ...
                var params = {
                    planID: _this.item.planID,
                    installID: _this.item.installId,
                    photo: _this.photo1,
                    empID: _this.empID,
                    jobtype: "SaveImgSerial"
                };
                console.log(params);
                _this.postDataService.SaveCaseAll(params).then(function (picserial) {
                    _this.picserial = _this.apiServer_url + picserial;
                    if (_this.type == 'CM') {
                        var params_1 = {
                            item: _this.item,
                        ...
                        var params_2 = {
                            ...
                            install: _this.item,
                            data: _this.data,
                            insID: _this.item.installId,
                            sparetype: _this.item.sparepart,
                            item: _this.item,
                            type: _this.type,
                        };
    ...
    PicserialPage.ctorParameters = function () { return [
...
//# sourceMappingURL=page-detaillistpm-picserial-picserial-module-es5.js.map